...
map.getView().fit([1230586.840564, 309867.377122, 1269634.402976, 334154.228469], map.getSize());
    ...
    element: (() => {
        ...
        if (101 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Cette carte présente quelques information sur les restaurants,quartiers, ecoles hopitaux et phamacies';
            }
